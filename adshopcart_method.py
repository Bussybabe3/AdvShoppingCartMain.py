...
def setUp():
    ...
    if driver.current_url == locators.advantage_shopping_Url and driver.title == locators.advantage_shopping_home_page_title:
...
def log_in():
    if driver.current_url == locators.advantage_shopping_url:  # check we are on the home page
        ...
        if driver.current_url == locators.advantage_shopping_login_page_url and driver.title == locators.advantage_shopping_login_page_title: # check we are on the login
